    ...
    <section className="education">
      ...
      <div className="education__container">
        <div className="education__item">
          <h3 className="education__degree">Advanced Diploma Computer Programming & Analysis</h3>
        ...
        <div className="education__item">
          ...
          <p className="education__university"> Massachussetts Institute of Technology - IDSS </p>
